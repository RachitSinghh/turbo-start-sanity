...
// Source: ../../packages/sanity/src/query.ts
// Variable: queryBlogPostForAlgoliaSync
// Query: *[_type == "blog" && _id == $id][0]{    _id,    title,    description,    "slug": slug.current,    category,    publishedAt,    "author": authors[0]->name,    seoNoIndex,    seoHideFromLists  }
export type QueryBlogPostForAlgoliaSyncResult = {
  _id: string;
  title: string;
  description: string | null;
  slug: string | null;
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    '\n  *[_type == "blog" && _id == $id][0]{\n    _id,\n    title,\n    description,\n    "slug": slug.current,\n    category,\n    publishedAt,\n    "author": authors[0]->name,\n    seoNoIndex,\n    seoHideFromLists\n  }\n': QueryBlogPostForAlgoliaSyncResult;
